...
module.exports = {
  ...
  activate() {
    ...
    this.subscriptions = new CompositeDisposable(
      ...
      atom.workspace.addOpener(uri => {
        if (uri === HOME_PAGE_URI) {
          if (!StartPage) StartPage = require("./start-page")
          return new StartPage(HOME_PAGE_URI)
        }
      })
    )
    ...
    if (settings.get("showStartPage")) this.openHomePageItem()
  },

  openHomePageItem() {
    atom.workspace.open(HOME_PAGE_URI, {searchAllPanes: true})
  },
